...
par(mfrow=c(3,2))
par(mar=c(2,9,2,2))
barplot(pgr16_top10, horiz = T, las = 1)
barplot(pgr17_top10, horiz = T, las = 1)
barplot(pgr18_top10, horiz = T, las = 1)
barplot(pgr19_top10, horiz = T, las = 1)
barplot(pgr20_top10, horiz = T, las = 1)

com_fast_greedy16 <- cluster_fast_greedy(g16) 
com_infomap16 <- cluster_infomap(g16) 
com_louvain16 <- cluster_louvain(g16) 
compare(com_fast_greedy16, com_infomap16)
